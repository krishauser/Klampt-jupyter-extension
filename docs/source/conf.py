...
# -*- coding: utf-8 -*-
#
# klampt_jupyter documentation build configuration file
#
...
project = 'klampt_jupyter'
copyright = '2022, Kris Hauser'
author = 'Kris Hauser'
...
_version_py = os.path.join(repo, 'klampt_jupyter', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'klampt_jupyterdoc'
...
latex_documents = [
    (master_doc, 'klampt_jupyter.tex', 'klampt_jupyter Documentation',
     'Kris Hauser', 'manual'),
]
